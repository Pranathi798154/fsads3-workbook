  ...
  return (
    <main className="app-shell">
      <section className="hero-card">
        <p className="eyebrow">Skill 12 - Full-Stack CRUD Application</p>
        <h1>Student Management System</h1>
        <p className="hero-copy">
          React frontend integrated with a Spring Boot backend for adding,
          viewing, updating, and deleting student records without page reloads.
        </p>
      </section>
